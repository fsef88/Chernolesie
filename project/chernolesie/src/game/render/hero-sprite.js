...
// v7.42 ВОИН РАЗМАХИВАЛ МЕЧОМ НА ХОДУ.
//  В цикле ХОДЬБЫ стояли кадры 6 и 8, а это кадры УДАРА, и в них впечатан
//  жёлто-зелёный росчерк клинка: замер по листу даёт 22.2% таких пикселей в
//  кадре 6 и 8.3% в кадре 8 (в кадрах ходьбы 0.5-1.2%). Игрок просто шёл, а
//  вокруг героя дважды за цикл вспыхивала зелёная дуга — она и читается как
//  «герой пропал, вместо него картинка».
//  Чистых поз ходьбы на листе три: 3, 4, 5. Цикл собран из них с удержанием
//  по два слота — восемь слотов сохранены, значит темп шага остался прежним
//  (он посчитан из длины цикла в drawSprite), а росчерка в ходьбе больше нет.
//  Кадры 6, 8, 10, 11 остаются в ударе: там взмах и правда происходит.
const HERO_LAYOUT={warrior:{idle:[1,2,3,4],walk:[3,3,4,4,5,5,4,4],atk:[7,8,11,12,13,14],n:16},druid:{idle:[1,2,3,4],walk:[1,2,3,4,5,6,5,4],atk:[3,8,12,13,14,15],n:16},rogue:{idle:[1,2,3,4],walk:[13,14,6,7,8,9,10,9],atk:[8,3,9,11,12,13],n:16},shaman:{idle:[9,10],walk:[2,3,4,5,6,7,8,1],atk:[11,12,13,14],ult:[15,16],ultSeq:[15,15,16,16,16,16,14,11,10],atkHit:0.12,n:16},archer:{idle:[1,16,15,14],walk:[1,16,15,14,13,12,13,14],atk:[9,12,2,3,4,5],n:16},ognevik:{idle:[1,2,3,4],walk:[1,2,3,4,5,6,5,4],atk:[13,9,8,3,2,1],n:16},groznik:{idle:[1,2,3,4],walk:[1,2,3,4,5,6,5,4],atk:[2,3,15,14,13,12],n:16}}; // v5.48: живые Знахарка/Страж + новый Грозник
