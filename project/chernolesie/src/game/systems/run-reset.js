...
gemPops.length=0;absorbGlow=0;   // v6.42
 ...
 shake=0;hitstop=0;timeScale=1;slowmo=0;zoomPunch=1;mkN=0;mkX=0;mkY=0;mkFlash=0;mkBest=0;_clutchArmed=false;_minMark=0;_hbT=0;formCd=26;form=null;waveIdx=0;   // v6.56: ранняя формация сохраняется после resetRun
